...
const TouchWhatYouHear = ({
    ...
    const { currentScore, lifePoint, listenings } = useSelector(
        (state) => state.actions
    );
    ...
    const [words, setWords] = useState([
        ...listenings[questionIndex].questionData.words,
    ]);
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            setAnswer([]);
            setWords(
                listenings[questionIndex + 1]?.questionData?.words
                    ? [...listenings[questionIndex + 1].questionData.words]
                    : []
            );
